...
import TrianglePlayIcon from "../../assets/img/play-trailer.svg";
...
<template>
  <section class="hero-banner">
    <picture data-aos="fade-zoom-in">
      ...
      <source
        srcset="
          https://xl.movieposterdb.com/09_05/2007/413300/xl_413300_d050a0de.jpg
        "
      />
      <img
        srcset="
    ...
    <div class="blocks" data-aos="fade-zoom-in" data-aos-delay="500">
      ...
      <div class="btn-m" v-if="isMobile()">
        ...
        <div class="play-m">
          <button type="button">
            <TrianglePlayIcon /> <span>Xem ngay</span>
          </button>
        </div>
        <div class="info-m">
          <InfoIcon />
